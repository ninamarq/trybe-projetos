...
CREATE TABLE SpotifyClone.subscribe(
...
CREATE TABLE SpotifyClone.user_overview(
	user_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    plan_id INT NOT NULL,
    user_age INT NOT NULL,
    user_name VARCHAR(50) NOT NULL,
    subscribe_date Datetime NOT NULL,
    FOREIGN KEY (plan_id) REFERENCES SpotifyClone.subscribe(plan_id)
) engine = InnoDB;
...
CREATE TABLE SpotifyClone.user_history(
    ...
    FOREIGN KEY (user_id) REFERENCES SpotifyClone.user_overview(user_id),
...
INSERT INTO SpotifyClone.subscribe (plan_name, plan_price)
VALUES
	('gratuito', 0),
	('familiar', 7.99),
	('universitário', 5.99),
...
INSERT INTO SpotifyClone.songs (album_id, song_name, song_duration)
VALUES 
	(1, "Soul For Us", 200),
...
INSERT INTO SpotifyClone.user_overview (user_name, user_age, plan_id, subscribe_date)
VALUES
...
INSERT INTO SpotifyClone.user_history (user_id, song_id, reprodution_date)
VALUES
